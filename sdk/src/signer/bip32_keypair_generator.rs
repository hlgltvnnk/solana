...
// https://github.com/jpopesculian/ed25519-dalek-bip32/blob/main/src/lib.rs
...
use ed25519_dalek::{hazmat::ExpandedSecretKey, SecretKey, VerifyingKey};
...
impl ExtendedSecretKey {
    ...
    pub fn derive_child(&self, index: ChildIndex) -> Result<Self> {
        ...
        mac.update(&[0u8]);
        mac.update(self.secret_key.as_ref());
    ...
    pub fn public_key(&self) -> VerifyingKey {
        VerifyingKey::from(&ExpandedSecretKey::from(&self.secret_key))
    }
